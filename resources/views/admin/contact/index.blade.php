        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="{{ route('contact.show', $value->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm" title="@lang('general.locales.show')">
                            <i class="la la-eye"></i>
                        </a>
                        <a href="{{ route('contact.show-reply', $value->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm" title="@lang('general.locales.reply')">
