...
@section('store_route', route('faq.store'))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[question]' }}" placeholder="@lang('faq.question')" class="form-control  pl-5 min-h-40px @error($locale . '.question') is-invalid @enderror" value="{{ old($locale . '.question') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[answer]' }}" placeholder="@lang('faq.answer')" class="form-control  pl-5 min-h-40px @error($locale . '.answer') is-invalid @enderror" value="{{ old($locale . '.answer') }}">
                            </div>
                        </div>
