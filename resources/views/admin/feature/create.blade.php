...
@section('store_route', route('feature.store'))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[name]' }}" placeholder="@lang('feature.name')" class="form-control  pl-5 min-h-40px @error($locale . '.name') is-invalid @enderror" value="{{ old($locale . '.name') }}">
                            </div>
                        </div>
                        <div class="form-group">
