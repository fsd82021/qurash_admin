...
@section('module_name') @lang('gallery.gallery') @endsection
@section('page_type') @lang('general.index') @endsection
@section('title') @lang('gallery.gallery') @endsection
@section('create_route', route('gallery.create'))
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td nowrap="nowrap">
                        @include('admin.components.table-control', ['name'=>'gallery', 'value'=>$value])
                    </td>
                </tr>
            @endforeach
        </tbody>
