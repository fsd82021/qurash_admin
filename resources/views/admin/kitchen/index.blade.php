...
@section('module_name') @lang('kitchen.kitchen') @endsection
@section('page_type') @lang('general.index') @endsection
@section('title') @lang('kitchen.kitchen') @endsection
@section('create_route', route('kitchen.create'))
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td nowrap="nowrap">
                        @include('admin.components.table-control', ['name'=>'kitchen', 'value'=>$value])
                    </td>
                </tr>
            @endforeach
        </tbody>
