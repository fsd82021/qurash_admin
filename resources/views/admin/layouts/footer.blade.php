<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-end">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="https://marwan.tech/ar" target="_blank" class="text-dark-75 text-hover-primary">Marwan Tech © 2022</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
        ...
        var demos = function() {
            ClassicEditor
                .create(document.querySelector('.en-kt-ckeditor-5'), {
                    toolbar: ["heading", '|', "bold", "italic", "blockQuote", "imageTextAlternative", "imageUpload", "imageStyle:full",
                        "imageStyle:side", "link", "numberedList", "bulletedList", "mediaEmbed", "insertTable", "tableColumn", "tableRow",
    ...
    var KTDatatablesAdvancedColumnRendering = function() {
        ...
        var init = function() {
            ...
            table.DataTable({
                ...
                ordering: false,
                language: {
                    "url": `https://cdn.datatables.net/plug-ins/1.11.3/i18n/{{app()->getLocale()}}.json`,
                }
            });
