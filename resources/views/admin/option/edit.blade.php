...
@section('store_route', route('option.update', $data))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[value]' }}" id="{{ $locale . '[value]' }}" placeholder="@lang('service.value')" class="form-control pl-5 min-h-40px @error($locale . '.value') is-invalid @enderror" value="{{ old($locale . '.value',$data->translate($locale)->value) }}">
                            </div>
                        </div>
                    </div>
                @endforeach
