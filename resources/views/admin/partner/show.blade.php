...
@section('fields_content')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('partner.img_alt'):</h5>
                                    </div>
    ...
    <div class="card card-custom card-stretch gutter-b">
        <div class="card-body p-10">
            <div class="card-title">
                <h5 class="font-weight-bolder text-dark">@lang('partner.image'):</h5>
            </div>
            <!--begin::Image-->
            @if (isset($data->image))
                <div class="card-body p-0 px-1 py-1">
                    <img src="{{ asset($data->image) }}" style="max-width: 100%" class="rounded img-fluid">
                </div>
            @endif
            <!--end::Image-->
        </div>
