...
@section('store_route', route('service.update', $data))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[title]' }}" placeholder="@lang('service.title')" class="form-control  pl-5 min-h-40px @error($locale . '.title') is-invalid @enderror" value="{{ old($locale . '.title', $data->translate($locale)->title) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label>@lang('service.image_alt') - @lang('general.'.$locale)<span class="text-danger"> * </span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="flaticon-edit"></i></span>
                                </div>
                                <input type="text" name="{{ $locale . '[img_alt]' }}" placeholder="@lang('service.img_alt')" class="form-control  pl-5 min-h-40px @error($locale . '.img_alt') is-invalid @enderror" value="{{ old($locale . '.img_alt', $data->translate($locale)->img_alt) }}">
                            </div>
                        </div>
                    </div>
                @endforeach
