            ...
            <div class="tab-content">
                @foreach (config('translatable.locales') as $key => $locale)
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        ...
                        <div class="form-group">
                            <label>@lang('settings.copyrights') - @lang('general.'.$locale)<span class="text-danger"> * </span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="flaticon-edit"></i></span>
                                </div>
                                <input type="text" name="{{ $locale . '[copyrights]' }}" placeholder="@lang('settings.copyrights')" class="form-control pl-5 min-h-40px @error($locale . '.copyrights') is-invalid @enderror" value="{{ old($locale . '.copyrights', $data->translate($locale)->copyrights) }}">
                            </div>
                        </div>
                        <div class="form-group">
