...
@section('store_route', route('testimonial.update', $data))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[name]' }}" placeholder="@lang('testimonial.name')" class="form-control  pl-5 min-h-40px @error($locale . '.name') is-invalid @enderror" value="{{ old($locale . '.name', $data->translate($locale)->name) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[description]' }}" placeholder="@lang('testimonial.description')" class="form-control  pl-5 min-h-40px @error($locale . '.description') is-invalid @enderror" value="{{ old($locale . '.description', $data->translate($locale)->description) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[img_alt]' }}" placeholder="@lang('testimonial.img_alt')" class="form-control  pl-5 min-h-40px @error($locale . '.img_alt') is-invalid @enderror" value="{{ old($locale . '.img_alt', $data->translate($locale)->img_alt) }}">
                            </div>
                        </div>
                    </div>
                @endforeach
