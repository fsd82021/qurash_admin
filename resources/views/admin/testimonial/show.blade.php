...
@section('fields_content')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-5">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('testimonial.title'):</h5>
                                    </div>
                                    <p class="m-0">{{ $data->translate($locale)->name }}</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-5">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('testimonial.description'):</h5>
                                    </div>
                            ...
                            <div class="col-md-6 mb-5">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('testimonial.img_alt'):</h5>
                                    </div>
                                    <p class="m-0">{{ $data->translate($locale)->img_alt }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card card-custom card-stretch gutter-b">
        <div class="card-body p-10">
            <div class="card-title">
                <h5 class="font-weight-bolder text-dark">@lang('testimonial.image'):</h5>
            </div>
            <!--begin::Image-->
            @if (isset($data->image))
